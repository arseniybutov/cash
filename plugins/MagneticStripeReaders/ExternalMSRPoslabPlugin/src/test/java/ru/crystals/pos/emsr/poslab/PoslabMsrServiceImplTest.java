...
public class PoslabMsrServiceImplTest {

    private PoslabMsrServiceImpl service;

    @Before
    public void init() {
        service = new PoslabMsrServiceImpl(new TrackProcessorImpl());
    }
    ...
    public void getTracksTest() {
        ...
        List<Integer> scanCodeList = ("%5B55476198236933344^6MC  STANDARD//TEST           ^191120115432000002088?" +
                ...
                ";24490000000299?").chars().boxed().collect(Collectors.toList());
