...
public class CFTGiftCardViewForm extends CommonProductForm<ProductEntity,
        PositionEntity,
    ...
    public CFTGiftCardViewForm(XListener outerListener) {
        super(outerListener);
        CFTGiftCardViewForm.this.setName("ru.crystals.pos.visualization.products.cftcard.CFTGiftCardViewForm");
    }
