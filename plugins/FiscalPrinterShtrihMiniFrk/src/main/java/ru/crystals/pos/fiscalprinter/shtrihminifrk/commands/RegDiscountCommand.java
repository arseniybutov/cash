 ...
 */
public class RegDiscountCommand extends BaseCommand<Object> {
     ...
     */
    public RegDiscountCommand(ShtrihDiscount discount, int password) {
        super(password);

        if (discount == null) {
            throw new IllegalArgumentException("RegDiscountCommand: the argument is NULL!");
        }
    ...
    public String toString() {
        return String.format("reg-discount-cmd [discount: %s]", discount);
    }
