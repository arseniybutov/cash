...
/**
 * Команда "Прекращение ЭКЛЗ" (прекращение сеанса чтения данных из ЭКЛЗ).
 * <p/>
 * {@link #decodeResponse(byte[]) Ответ} от данной команды не имеет объектного представления (всегда будет <code>null</code>).
 * 
 * @author aperevozchikov
 */
public class StopEklzSessionCommand extends BaseCommand<Object> {
     ...
     */
    public StopEklzSessionCommand(int password) {
        super(password);
    }

    @Override
    public String toString() {
        return String.format("stop-eklz-cmd");
    }
