package ru.crystals.pos.visualization.products.pieceweight;
...
public class ResBundleGoodsPieceWeight {
	private static final String BUNDLE_NAME = "res-goods-pieceweight";
