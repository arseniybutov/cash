...
public class CFTEGCPaymentConfirmForm extends AbstractPaymentForm<PaymentEntity, CommonPaymentHeaderPanel, CommonPaymentPaidPanel, CommonPaymentToPayPanel,
        CommonProductInputPanel, CFTEGCPaymentController> {
    private static final long serialVersionUID = -2332582872485631288L;

    public CFTEGCPaymentConfirmForm(XListener outerListener) {
        super(outerListener);
    }
