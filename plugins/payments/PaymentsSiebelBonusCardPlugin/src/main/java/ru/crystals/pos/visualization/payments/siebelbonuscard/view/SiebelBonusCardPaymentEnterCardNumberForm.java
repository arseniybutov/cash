...
public class SiebelBonusCardPaymentEnterCardNumberForm extends
    ...
    public SiebelBonusCardPaymentEnterCardNumberForm(XListener outerListener) {
        super(outerListener);
    }
    ...
    public CommonPaymentHeaderPanel createHeaderPanel() {
        return new CommonPaymentHeaderPanel(ResBundlePaymentSiebelBonusCard.getString("SIEBEL_BONUSCARD_PAYMENT"),
                ResBundlePaymentSiebelBonusCard.getString("SIEBEL_BONUSCARD_PAYMENT"));
    }
    ...
    public boolean keyPressedNew(XKeyEvent e) {
        ...
        if (e.getKeyCode() == KeyEvent.VK_ENTER) {
            if (footerPanel.getTextValue() == null || footerPanel.getTextValue().isEmpty()) {
                if (controller != null) {
                    controller.beepError("SiebelBonusCardPayment: empty card number field, cannot process info");
                }
                return true;
            }
            return false;
