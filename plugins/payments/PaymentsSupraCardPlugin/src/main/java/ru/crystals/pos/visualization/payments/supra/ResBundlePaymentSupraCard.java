package ru.crystals.pos.visualization.payments.supra;
...
public class ResBundlePaymentSupraCard {

    private static final String BUNDLE_NAME = "res-payments-supraCard";
