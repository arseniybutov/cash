 ...
 */
public class CbsKPKEmulator {
    private static final Logger LOG = LoggerFactory.getLogger(CbsKPKEmulator.class);

    private static final String SHIFT_NUM_PARAMETER = "ShiftNum";
    private static final String Z_REPORT_STARTED = "ZReportStarted";
    private static final String COUNTERS_STORAGE = "cbs_counters.properties";
    ...
    public boolean isZReportStarted() {
        return Boolean.parseBoolean(properties.getProperty(Z_REPORT_STARTED));
    }

    public void setZReportStarted(boolean started) {
        setStringProperty(Z_REPORT_STARTED, Boolean.toString(started));
    }
