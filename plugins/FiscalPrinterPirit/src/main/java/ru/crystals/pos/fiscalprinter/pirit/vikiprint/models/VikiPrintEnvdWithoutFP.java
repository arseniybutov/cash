...
public class VikiPrintEnvdWithoutFP extends AbstractVikiPrint {
    protected final Logger log = LoggerFactory.getLogger(VikiPrintEnvdWithoutFP.class);
    private FiscalPrinterData fiscalData;

    public static boolean isEnvdFirmware(long firmwareId) {
        return firmwareId >= 400 && firmwareId <= 499;
    }
