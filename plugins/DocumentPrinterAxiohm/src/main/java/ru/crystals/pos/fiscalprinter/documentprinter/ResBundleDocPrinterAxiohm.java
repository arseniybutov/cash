package ru.crystals.pos.fiscalprinter.documentprinter;
...
public class ResBundleDocPrinterAxiohm {
    private static final String BUNDLE_NAME = "res-docPrinter-axiohm";
