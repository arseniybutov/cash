...
public class CiggyEditForm extends CommonProductForm<ProductEntity, PositionEntity, CommonDefaultProductHeaderPanel, AbstractProductUnitPriceComponent, CommonProductSummPanel, CommonProductQuantityPanel> {

    public CiggyEditForm(XListener outerListener) {
        super(outerListener);
        CiggyEditForm.this.setName(CiggyEditForm.class.getName());
    }
