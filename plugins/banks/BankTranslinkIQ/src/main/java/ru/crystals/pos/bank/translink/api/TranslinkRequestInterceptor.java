...
public class TranslinkRequestInterceptor implements ClientHttpRequestInterceptor {

    private static final Logger log = LoggerFactory.getLogger(TranslinkRequestInterceptor.class);
