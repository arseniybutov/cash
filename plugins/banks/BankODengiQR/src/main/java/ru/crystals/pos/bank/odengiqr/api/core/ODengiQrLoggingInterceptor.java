...
public class ODengiQrLoggingInterceptor implements ClientHttpRequestInterceptor {

    private static final Logger log = LoggerFactory.getLogger(ODengiQrLoggingInterceptor.class);
