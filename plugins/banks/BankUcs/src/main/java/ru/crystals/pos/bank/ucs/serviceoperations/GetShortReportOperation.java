...
public class GetShortReportOperation extends UCSServiceOperation {
    @Override
    public Request createRequest() throws BankException {
        return new GetReportRequest(GetReportRequest.ReportType.SHORT);
    }
    ...
    public String getCommandTitle() {
        return ResBundleBankUcs.getString("SHORT_REPORT_COMMAND_TITLE");
    }

    @Override
    public String getFormTitle() {
        return ResBundleBankUcs.getString("SHORT_REPORT_FORM_TITLE");
    }

    @Override
    public String getSpinnerMessage() {
        return ResBundleBankUcs.getString("SHORT_REPORT_SPINNER_MESSAGE");
    }
}
