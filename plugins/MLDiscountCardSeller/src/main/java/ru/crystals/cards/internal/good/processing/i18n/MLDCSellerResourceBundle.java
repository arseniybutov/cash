 ...
 */
public class MLDCSellerResourceBundle {
    private static final Logger log = LoggerFactory.getLogger(MLDCSellerResourceBundle.class);

    private static final String RESOURCE_BUNDLE_NAME = "ml-dc-seller-messages";
